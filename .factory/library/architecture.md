...
└── Promotion Components (src/components/promotion/)
    ...
    ├── SidebarBar (collapsed column sidebar — vertical for desktop, horizontal for mobile)
    ├── ResizablePanels (generic split-pane with drag handle, supports vertical/horizontal)
